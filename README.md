...
| Diabetes type issues | Patients with discrepancies between their diabetes type as determined above and other variables in their records need to be investigated further | Rules based on https://onlinelibrary.wiley.com/doi/10.1111/j.1464-5491.2011.03419.x and the National Diabetes Audit:
* Type 1 with no insulin prescriptions (affected <2% of our Type 1 cohort
*  |
