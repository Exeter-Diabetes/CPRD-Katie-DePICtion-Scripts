...
| Median (IQR) time from BMI within 2 years to index date (days) 
| Median (IQR) BMI any time >=diagnosis (kg/m2) | 26.4 (6.5) | 31.2 (8.8) | 29.1 (9.1) |||
| Missing BMI >=diagnosis | 273 (1.83%) | 1970 (1.18%) | 10310 (31.45%) |||
| Median (IQR) time from BMI any time >=diagnosis to index date (days)
...
| Median (IQR) time from total cholesterol within 2 years to index date (days) 
...
| Median (IQR) time from triglyceride within 2 years to index date (days) 
| Median (IQR) triglyceride any time >=diagnosis (mmol/L) 
| Missing triglyceride >=diagnosis | 1.1 (0.8) | 1.7 (1.3) | 1.4 (1.1) |||
| Median (IQR) time from triglyceride any time >=diagnosis to index date (days) | 1531 (10.28%) | 11115 (6.64%) | 16221 (49.48%) |||
